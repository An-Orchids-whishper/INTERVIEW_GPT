...
const VoiceInterview = () => {
 ...
 const submitAnswer = async () => {
  ...
  try {
    ...
    // 🟢 Localhost hata kar dynamic URL set kar diya hai
    ...
    if (currentIndex < questions.length - 1) {
      ...
      setAnswer(""); // Agle sawal ke liye purana jawab clear kar do
      finalAnswer.current = "";
      hasSpoken.current = false;
    } else {
      setReviewMode(true);
    ...
    alert("Evaluation failed. Backend waking up, please try again in 30 seconds.");
  }
};
